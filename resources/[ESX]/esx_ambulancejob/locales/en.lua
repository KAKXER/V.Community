Locales['en'] = {
  ...
  ['garage_prompt'] = 'Dokme ~INPUT_CONTEXT~ jahat baz kardan ~y~Menu Mashin~s~.',
  ...
  ['garage_notavailable'] = 'shoma mashin az garage dar avardid',
  ['garage_blocked'] = '~r~Garage Por shode nemitoni mashin Spawn Koni~s~',
  ...
  ['actions_prompt'] = 'Dokme ~INPUT_CONTEXT~ jahat baz kardan ~y~Menu~s~.',
  ['deposit_amount'] = 'deposit Amount',
  ['money_withdraw'] = 'amount withdrawn',
  ['fast_travel'] = 'press ~INPUT_CONTEXT~ to fast travel.',
  ['open_pharmacy'] = 'Dokme ~INPUT_CONTEXT~ Jahat bardashtan ~r~medikit~s~ va ~r~bandage~s~ ',
  ...
  ['distress_send'] = 'Dokme [~b~E~s~] Jahat Ersal Payam Be Bimarestam',
  ['distress_sent'] = 'Payam Shoma Be ~g~Bimarestan~s~ Ersal shod.',
  ['distress_message'] = 'Alo salam Lotfan Yeki Komak Kone Inja Yek Nafar zakhmi shode!',
  ['combatlog_message'] = 'akharin Bari ke ~r~Disconnect~s~ dade Bodid morde Bodid dobare az Aval~g~ Respawn~s~ Mishavid.',
  -- Revive
