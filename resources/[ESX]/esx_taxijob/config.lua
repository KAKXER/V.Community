...
Config.Zones = {
	...
	VehicleDeleter = {
		Pos     = {x = 902.16, y = -144.26, z = 75.23},
		Size  = {x = 2.0, y = 2.0, z = 1.50},
		Color = {r = 204, g = 204, b = 0},
		Type  = 1, Rotate = false
	},

	TaxiActions = {
		Pos   = {x = 903.18, y = -161.98, z = 76.88},
