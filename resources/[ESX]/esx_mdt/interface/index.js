...
$(document).ready(() => {
    ...
    function JobColors(sentJob) {
        ...
        if (sentJob) {
            if (sentJob == 'police') {
                ...
                $(".badge-logo").attr('src','nui://X-scripts/nui/images/logo/police.png');
                ...
                $(".roster-iframe").attr("src", "https://docs.google.com/spreadsheets/d/1I1ithgJc_s3Hrg4KfQC8VV8Ino-T6qUZxj9yYqsW1RU/edit#gid=351611418")    
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            if ($(".badge-logo").attr('src') == 'nui://X-scripts/nui/images/logo/police.png') {
            ...
            let table = e.data
            let image = "https://cdn.discordapp.com/attachments/996093699060678677/1055498121142079508/5c46a9031ba2c975dfcf1b3ff4af3e4d.webp"
            $(".weapons-items").empty();
            canSearchForVehicles = true
            $.each(table, function (index, value) {
                if (value.image) {
