Locales['en'] = {
  ...
  ['imp_invalid_amount'] = 'meghdar item shoma ~r~invalid~s~ ast!',
  ['threw_standard'] = 'shoma item ~b~%s~s~ ra drop kardid tedad ~y~%s adad~s~ ast.',
  ...
  -- Salary related
  ['received_salary'] = 'Salary shoma: ~g~$%s~s~',
