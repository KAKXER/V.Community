...
DP.Emotes = {
    ["sex1"] = {"mini@prostitutes@sexnorm_veh", "bj_loop_male", "+18 Mamada en coche (Hombre)", AnimationOptions =
    {
         EmoteLoop = true,
         EmoteMoving = true,
         allowedincars =true,
    }},
    ["sex2"] = {"mini@prostitutes@sexnorm_veh", "bj_loop_prostitute", "+18 Mamada en coche (Mujer)", AnimationOptions =
    {
         EmoteLoop = true,
        EmoteMoving = true,
        allowedincars =true,
    }},
    ["sex3"] = {"mini@prostitutes@sexnorm_veh", "sex_loop_male", "+18 Follar en coche 1 (Hombre)", AnimationOptions =
    {
         EmoteLoop = true,
         EmoteMoving = false,
         allowedincars =true,
    }},
    ["sex4"] = {"mini@prostitutes@sexnorm_veh", "sex_loop_prostitute", "+18 Follar en coche 1 (Mujer)", AnimationOptions =
    {
         EmoteLoop = true,
        EmoteMoving = false,
        allowedincars =true,
    }},
    ["sex5"] = {"oddjobs@towing", "m_blow_job_loop", "+18 Mamada (Hombre)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
        allowedincars =true,
    }},
    ["sex6"] = {"oddjobs@towing", "f_blow_job_loop", "+18 Mamada (Mujer)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
        allowedincars =true,
    }},
    ["sex7"] = {"mini@prostitutes@sexlow_veh", "low_car_sex_loop_player", "+18 Follar en coche 2 (Hombre)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
        allowedincars =true,
    }},
    ["sex8"] = {"mini@prostitutes@sexlow_veh", "low_car_sex_loop_female", "+18 Follar en coche 2 (Mujer)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
        allowedincars =true,
