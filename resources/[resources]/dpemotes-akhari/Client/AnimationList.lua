...
DP.Aim = {
    ...
    ["Gangster"] = {"Gang1H"},
    ["Cowboy"] = {"Hillbilly"},
    ["AnimWeapon1"] = {"FirstPersonAiming"},
    ["AnimWeapon2"] = {"FirstPerson"},
    ["AnimWeapon3"] = {"FirstPersonFranklin"},
    ["AnimWeapon4"] = {"FirstPersonTrevorScope"},
}
...
["slapped2"] = {"melee@unarmed@streamed_variations", "victim_takedown_front_backslap", "Slapped 2", "slap2"},
 ["sex1"] = {"misscarsteal2pimpsex", "pimpsex_punter", "sex1", "sex2", AnimationOptions =
  {
      EmoteMoving = false,
      EmoteDuration = 30000,
      SyncOffsetFront = 0.63
  }},
  ["sex2"] = {"misscarsteal2pimpsex", "pimpsex_hooker", "sex2", "sex1", AnimationOptions =
  {
      EmoteMoving = false,
      EmoteDuration = 30000,
      SyncOffsetFront = 0.63
  }},
  ["sex3"] = {"misscarsteal2pimpsex", "shagloop_pimp", "sex3", "sex4", AnimationOptions =
  {
      EmoteMoving = false,
      EmoteLoop = true,
  ...
  ["sex4"] = {"misscarsteal2pimpsex", "shagloop_hooker", "sex4", "sex3", AnimationOptions =
  {
      EmoteMoving = false,
      EmoteLoop = true,
      SyncOffsetFront = 0.50
...
DP.Dances = {
    ["jdrill"] = {"anim@amb@nightclub_island@dancers@crowddance_single_props@", "mi_dance_prop_13_v1_male^3", "Dance · Male", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill2"] = {"anim@amb@nightclub_island@dancers@crowddance_groups@groupd@", "mi_dance_crowd_13_v2_male^1", "Dance · Male 2", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill3"] = {"anim@amb@nightclub_island@dancers@crowddance_facedj@", "mi_dance_facedj_17_v2_male^4", "Dance · Male 3", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill4"] = {"anim@amb@nightclub_island@dancers@crowddance_facedj@", "mi_dance_facedj_15_v2_male^4", "Dance · Male 4", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill5"] = {"anim@amb@nightclub_island@dancers@crowddance_facedj@", "hi_dance_facedj_hu_15_v2_male^5", "Dance · Male 5", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jDrill6"] = {"anim@amb@nightclub_island@dancers@crowddance_facedj@", "hi_dance_facedj_hu_17_male^5", "Dance · Male 6", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill7"] = {"anim@amb@nightclub@mini@dance@dance_solo@shuffle@", "high_right_up", "Dance · Solo 1", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill8"] = {"anim@amb@nightclub@mini@dance@dance_solo@shuffle@", "med_center", "Dance · Solo 2", AnimationOptions =
    {
        EmoteLoop = true,
    }},
    ["jdrill9"] = {"anim@amb@nightclub@mini@dance@dance_solo@shuffle@", "high_right_down", "Dance · Solo 3", AnimationOptions =
    {
        EmoteLoop = true,
    }}, 
    ["jdrill10"] = {"anim@amb@nightclub@mini@dance@dance_solo@shuffle@", "high_center", "Dance · Solo 4", AnimationOptions =
    {
         EmoteLoop = true,
    }}, 
    ["jDrill11"] = {"anim@amb@nightclub@mini@dance@dance_solo@shuffle@", "high_left_down", "Dance · Solo 5", AnimationOptions =
    {
        EmoteLoop = true,
    }},
...
DP.Emotes = {
   ...
   ["stickup"] = {"random@countryside_gang_fight", "biker_02_stickup_loop", "Stick Up", AnimationOptions =
   {
    ...
    ["sitped1"] = {"instagrampose9@seimen", "instagrampose9_clip", "sitped1", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped2"] = {"instagrampose8@seimen", "instagrampose8_clip", "sitped2", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped3"] = {"instagrampose7@seimen", "instagrampose7_clip", "sitped3", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped4"] = {"instagrampose6@seimen", "instagrampose6_clip", "sitped4", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped5"] = {"instagrampose5@seimen", "instagrampose5_clip", "sitped5", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped6"] = {"instagrampose@seimen", "instagrampose_clip", "sitped6", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped7"] = {"instagrampose17@seimen", "instagrampose17_clip", "sitped7", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped8"] = {"instagrampose16@seimen", "instagrampose16_clip", "sitped8", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped9"] = {"instagrampose15@seimen", "instagrampose15_clip", "sitped9", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped10"] = {"instagrampose14@seimen", "instagrampose14_clip", "sitped10", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped11"] = {"instagrampose13@seimen", "instagrampose13_clip", "sitped11", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped12"] = {"instagrampose12@seimen", "instagrampose12_clip", "sitped12", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped13"] = {"LLShop@randompose1", "llshop_clip", "sitped13", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped14"] = {"LLShop@randompose2", "llshop_clip", "sitped14", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped15"] = {"LLShop@randompose3", "llshop_clip", "sitped15", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped16"] = {"LLShop@randompose4", "llshop_clip", "sitped16", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped17"] = {"LLShop@randompose5", "llshop_clip", "sitped17", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped18"] = {"LLShop@pose", "llshop_clip", "sitped18", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped19"] = {"LLShop@lookbehind", "llshop_clip", "sitped19", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped20"] = {"anim@model_car_fancy", "car_fancy_clip", "sitped20", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped21"] = {"anim@model_stretched_leg", "stretched_leg_clip", "sitped21", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped22"] = {"anim@car_sitting_fuckyou", "sitting_fuckyou_clip", "sitped22", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped23"] = {"anim@car_sitting_cute", "sitting_cute_clip", "sitped23", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped23"] = {"anim@model_bike", "bike_clip", "sitped23", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped24"] = {"anim@model_bike_two", "bike_two_clip", "sitped24", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped24"] = {"anim@peace_selfie", "peace_clip", "sitped24", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped25"] = {"anim@stance_folded_arms", "folded_arms_clip", "sitped25", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped26"] = {"anim@stance_kneeling_cute", "kneeling_cute_clip", "sitped26", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped27"] = {"anim@sit_cute_window", "cute_window_clip", "sitped27", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped28"] = {"anim@car_cute_sit", "cute_sit_clip", "sitped28", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped29"] = {"anim@selfie_peacesign_cute", "peacesign_cute_clip", "sitped29", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped30"] = {"thot_pose", "thot_clip", "sitped30", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["sitped31"] = {"anim@lbp_kneeling_point", "kneeling_point_clip", "Lean Beef Patty Style (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["sitped32"] = {"anim@cargirl_peace", "peace_clip", "Car Relaxed Sit (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["carpose33"] = {"anim@cargirl_look_back", "peace_clip", "Car Model Stance (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["sitped34"] = {"anim@model_flipoff_cute", "flipoff_cute_clip", "Cute Flipping Off Pose (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["sitped35"] = {"anim@model_kylie_insta", "kylie_insta_clip", "Kylie Kneeling (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["sitped36"] = {"anim@selfie_instagram_booty", "instagram_booty_clip", "Instagram Booty Selfie (Smos)", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
...
DP.PropEmotes = {
 ...
 ["drill"] = {"amb@world_human_const_drill@male@drill@base", "base", "Drill", AnimationOptions =
 {
    Prop = "prop_tool_jackham",
    PropBone = 57005,
    PropPlacement = {0.12, 0.22, 0.0, 45.0, 240.0, 96.0},
    EmoteLoop = true,
    EmoteMoving = true,
 }},
