    ...
    switch (v.action) {
        ...
        case 'LoadEmotes':
            ...
            $(`#${v.emotename}`).click(function() {
                emote = this.id
                $.post('https://dpemotes/executeemote', JSON.stringify({
                    emote: emote,
                    type: 'emote',
                }));
            });
...
$(document).keyup((e) => {
    if (e.key === "Escape") {
        $.post('https://dpemotes/exit', JSON.stringify({}));
    }
});
...
window.addEventListener('load', () => {
    $.post('https://dpemotes/callAnimations', JSON.stringify({})); 
});