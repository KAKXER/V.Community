...
if Config.SqlKeybinding then
  MySQL.ready(function()
	...
	AddEventHandler("dp:ServerKeybindCreate", function()
		...
		{id = srcid, keybind1 = "num4", emote1 = "", keybind2 = "num5", emote2 = "", keybind3 = "num6", emote3 = "", keybind4 = "num7", emote4 = "", keybind5 = "num8", emote5 = "", keybind6 = "num9", emote6 = ""}, function(created) print("[X-LOG] ^2"..GetPlayerName(src).."^7 Vared Server Shod.") TriggerClientEvent("dp:ClientKeybindGet", src, "num4", "", "num5", "", "num6", "", "num7", "", "num8", "", "num8", "") end)
	end)
