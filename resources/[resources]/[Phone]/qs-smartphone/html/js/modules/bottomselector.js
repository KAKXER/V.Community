$(document).on('click', '.phone-bottom-selector-close-button, .gray-background', function (e) {
	e.preventDefault();
	$('.gray-background').fadeOut(200);
	$('.phone-bottom-selector').animate({
		'bottom': '-100%'
	}, 200, function () {
...
function OpenSelector(title, items, cb, notClose) {
