...
var fpsmeter = new FPSMeter(document.querySelectorAll("div.fpsmeter")[0], {
	interval:  50,
	smoothing: 2,
	show:      'fps',
	toggleOn:  'click',
	...
	history: 30 // How many history states to show in a graph.
});
...
if (Config.SmartphoneFPSMeter) {
    $(".fpsmeter").css({"display": "block"});
    render();
}